        ...
        <section className={styles.esgFirst}>
         <div className={styles.esgFirstInner}>
          <div className={styles.textBox}>
           <strong>모두의 지속가능한 미래를 위한<br />카카오의 약속과 책임</strong>
           <br/>
           <span>
            카카오의 혁신과 우리의 연결이 모여 더 나은 세상, 지속가능한 미래를 함께 만들어 갑니다.
           </span>
          </div>
         </div>
        </section>
      ...
      {(showAllCards ? allCards : firstCards).map((card, i) => (
        <div key={i} className={styles.highlightCard}>
          ...
          <div className={styles.cardText}>
            ...
            <button type="button" className={styles.cardIcon}>＋</button>
          </div>
        </div>
      ))}
    </div>
  ...
  <div className={styles.sliderWrapper}>
    <div className={styles.sliderTrack}>
      <div className={styles.card}>
        <img className={styles.img1} src="/img/msci_logo.png" alt="MSCI" /><br/>
        <strong>ESG 평가<br/> A등급 2년 연속 획득</strong>
        <p>(2023~2024)</p>
        <img className={styles.img2} src="/img/outcome_01_250121.png" alt="MSCI A등급" />
      </div>
      <div className={styles.card}>
        <img className={styles.img1} src="/img/esg_logo.png" alt="ESG기준원" /><br />
        <strong>ESG 평가 통합 부문<br/> A등급 4년 연속 획득</strong>
        <p>(2021~2024)</p>
        <img className={styles.img2} src="/img/outcome_02_250121.png" alt="ESG A등급" />
      </div>
      <div className={styles.card}>
        <img className={styles.img1} src="/img/snp_logo.png" alt="S&P" /><br />
        <strong>ESG 평가 2년 연속<br/> ‘Top 1%’로 선정</strong>
        <p>(2023~2024)</p>
        <img className={styles.img2} src="/img/outcome_03.png" alt="S&P Top1%" />
      </div>
      <div className={styles.card}>
        <img className={styles.img1} src="/img/cdp_logo.png" alt="CDP" /><br />
        <strong>Climate Change<br/> 리더십A 획득</strong>
        <p>(2023)</p>
        <img className={styles.img2} src="/img/outcome_04.png" alt="CDP A등급" />
      </div>
    </div>
  </div>
</section>
...
<div className={styles.sliderContainer}>
  <div className={styles.sliderTrack} ref={indicatorRef}>
    ...
    <div className={`${styles.card} ${styles.green}`}>
      ...
      <p className={styles.smallP}>(scope1 + scope2)<br />22년 대비 20% 감소</p>
    ...
    <div className={`${styles.card} ${styles.blue}`}>
      ...
      <p>사외이사 구성 비율</p>
      <strong>62.5%</strong>
      <p className={styles.smallP}>이사회의 독립성 확보<br />(2024년 2월 기준)</p>
    ...
    <div className={`${styles.card} ${styles.pink}`}>
      ...
      <p>
        주요 기능 접근성
        <sup onClick={() => scrollToFootnote('note1')} className={styles.footnoteLink}>1)</sup>
        적용률
      </p>
      <strong>
        81.2%
        <sup onClick={() => scrollToFootnote('note2')} className={styles.footnoteLink}>2)</sup>
      </strong>
      <p className={styles.smallP}>모두가 누리는 서비스</p>
      <img src="/img/indicators_accessibility.png" alt="accessibility" />
    </div>

    <div className={`${styles.card} ${styles.blue}`}>
      <span className={styles.tag}>거버넌스</span>
      <p>경영진 ESG 성과지표 
        <br/>성과급<strong>15%</strong></p>
  ...
  <div className={styles.reportContainer}>
    ...
    <div className={styles.reportTextBox}>
      ...
      <p className={styles.description}>
        지속가능한 기업을 만들어가기 위한<br />
        카카오의 약속과 책임을 담은 ESG보고서를<br />
        매년 발간하고 있습니다.
      </p>
      ...
      <div className={styles.buttonGroup}>
        ...
        <button className={styles.downloadBtn}>시각장애인용 대체자료 ↓</button>
      </div>
    </div>
  ...
  <p className={styles.caption}>
    * 시각장애인 대체자료는 시각장애인과 독서장애인을 위해 데이지(Digital Accessible Information System) 파일로 제공되며,<br />
    별도의 플레이어나 기기를 통해서만 이용이 가능합니다. 보다 자세한 이용 방법은 국립장애인도서관 페이지를 참고하시기 바랍니다.
    <a href="#" className={styles.link}> 바로가기 ▶</a>
  </p>
...
<h2>파트너와 함께하는 지속가능한 성장</h2>
  <p className={styles.subText}>
    카카오 그룹은 파트너와 함께 성장한다는 믿음으로 선순환의 생태계를 만들어가고자<br />
  ...
  <div className={styles.sliderWrapper}>
    <div className={styles.sliderTrack} ref={partnerSliderRef}>
      <div className={`${styles.card} ${styles.purple}`}>
        ...
        <strong>379억원</strong>
        <p>(집행, 23년 12월 기준)</p>
        <div className={styles.hash}>#소상공인 #지역파트너<br />#카카오 #카카오임팩트</div>
        <img src="/img/img_fund_digital.png" alt="소상공인" />
      </div>
      ...
      <div className={`${styles.card} ${styles.brown}`}>
        ...
        <strong>100억원</strong>
        <p>(약정)</p>
        <div className={styles.hash}>#디지털 창작자<br />#카카오엔터테인먼트</div>
        <img src="/img/img_fund_creater.png" alt="창작자" />
      </div>
      ...
      <div className={`${styles.card} ${styles.pink}`}>
        ...
        <strong>741억원</strong>
        <p>(누적기부금, 24년 4월 기준)</p>
        <div className={styles.hash}>#이용자 #지역사회<br />#카카오같이가치</div>
        <img src="/img/img_fund_with.png" alt="같이가치" />
      </div>
      ...
      <div className={`${styles.card} ${styles.green}`}>
        ...
        <strong>300억원</strong>
        <p>(누적거래액, 24년 2월 기준)</p>
        <div className={styles.hash}>#소상공인 #지역 파트너<br />#카카오메이커스</div>
        <img src="/img/img_fund_farm.png" alt="농축수산물" />
      </div>

      <div className={`${styles.card} ${styles.blue}`}>
        <h3>택시기사 의료 생계비 지원,<br />의인 시상기금 등</h3>
        <strong>100억원</strong>
        <p>(약정)</p>
        <div className={styles.hash}>#모빌리티 종사자<br />#카카오모빌리티 #카카오임팩트</div>
        <img src="/img/img_fund_medic.png" alt="모빌리티" />
      </div>
      ...
      <div className={`${styles.card} ${styles.yellow}`}>
        ...
        <strong>260억원</strong>
        <p>(펀드 총 규모)</p>
        <div className={styles.hash}>#스타트업 #인디게임<br />#상생펀드 #카카오게임즈</div>
        <img src="/img/img_fund_indie.png" alt="카카오게임즈" />
      </div>
    </div>
  </div>
  ...
  <div className={styles.partnerArrows}>
    <button
      ...
      onClick={() => {
        const newIndex = Math.max(partnerIndex - 1, 0);
    ...
    <button
      ...
      onClick={() => {
        const newIndex = Math.min(partnerIndex + 1, 5);
        setPartnerIndex(newIndex);
        scrollToPartnerCard(newIndex);
      }}
    ...
    {[
      ...
      { title: "카카오메이커스", tags: "#재고없는생산 #제카버치 #새카버치" },
      { title: "카카오 소상공인 지원사업", tags: "#소상공인 #상생" },
      { title: "우리동네 단골시장", tags: "#소상공인 #상생 #디지털전환" },
      { title: "도로 위 히어로즈", tags: "#모빌리티 #의인상 #상생" },
      { title: "카카오 테크 캠퍼스", tags: "#IT인재육성 #지역사회 #대학연계" },
      ...
      <section className={styles.esgNews}>
        ...
        <ul>
          <li>
            <a href="https://www.futurechosun.com/archives/90263" target="_blank">
              2023 카카오의 약속과 책임 발간
            </a>
          </li>
        </ul>
      ...
      {/* 데이터 기준 */}
      <section className={styles.esgFootnote} id="note1">
        <h2>데이터 기준</h2>
        <p><strong>1)</strong> 접근성(accessibility)이란, 비장애인 뿐만 아니라 장애를 가진 사람 등도<br/> 웹/앱 서비스를 이용할 수 있도록 만드는 것</p>
      </section>
        <section className={styles.esgFootnote} id="note2">
        <p><strong>2)</strong> 출처 : 2023 접근성 실태조사<br/> - 카카오 주요 서비스 내 중요도 높은 기능만을 대상으로 하였음 </p>
        </section>
    </div>
    </section>
  );
